import { useState, useMemo, useEffect, useRef, cloneElement, isValidElement, type ReactElement } from 'react';
...
function AudioRecorder({
  ...
  const mergedChatInput =
    variant === 'chat' && chatInput && isValidElement(chatInput)
      ? cloneElement(chatInput as ReactElement<{ className?: string }>, {
          className: [chatInput.props.className, 'min-w-0'].filter(Boolean).join(' '),
        })
      : null;
